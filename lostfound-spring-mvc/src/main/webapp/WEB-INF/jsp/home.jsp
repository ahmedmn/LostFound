...
<my:pagetemplate>
	<jsp:attribute name="body">
		...
		<div class="jumbotron">
			...
			<p class="lead">This our Lost and Found project demo</p>
			<p>
				<a class="btn btn-lg btn-success"
					href="${pageContext.request.contextPath}/example/foo/1/platypus55?b=42"
					role="button">Call ExampleController</a>
			</p>
		</div>
<%-- 		<div class="row">
